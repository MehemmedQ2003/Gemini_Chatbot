...
const Main = () => {
    const { onSent, recentPrompt, setRecentPrompt, input, setInput, showResult, setShowResult, loading, resultData } = useContext(Context);
            ...
            <div className='main-container'>
                ...
                <div className='main-bottom'>
                    ...
                    <p className='bottom-info'>
                        Gemini may display inaccurateinfo, including about people, so double-check its responses. Your privacy and Gemini apps
                    </p>
                </div>
            </div>
        </div>
